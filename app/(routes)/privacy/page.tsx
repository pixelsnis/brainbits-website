      ...
      <div className="w-full flex flex-col gap-6 md:gap-0 items-stretch justify-start p-4 md:p-0">
        ...
        <div className="w-full px-1 md:px-0 md:max-w-[36rem] self-center flex flex-col items-stretch justify-start gap-6">
          ...
          <ContentSection title="Third-Party Services">
            <p>
              We use third-party services to help us provide our services, such
              as transcriptions, AI processing, and cloud storage. These
              services may have access to your data as necessary to perform
              their functions, but they are not permitted to use it for any
              other purpose.
            </p>
            <p>
          ...
          <ContentSection title="Analytics">
            <p>
              ...
              such as the features you access. This data is only used for
              internal purposes and is not shared with third parties or for
              marketing.
            </p>
          </ContentSection>
